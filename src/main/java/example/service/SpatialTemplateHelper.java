...
public class SpatialTemplateHelper {
  ...
  public NumberTemplate<Double> distanceSphere(
      ComparablePath<Point> geometryPath, Geometry geometry) {
   ...
   */
  public BooleanTemplate distanceWithin(
      ComparablePath<Point> geometryPath, Geometry geometry, Double maxDistance) {
    return Expressions.booleanTemplate(
