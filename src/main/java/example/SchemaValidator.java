...
public class SchemaValidator {
    ...
    @Autowired
    private MetaEntityValidationService metaEntityValidationService;
    ...
    public void validateSchema() {
        ...
        Stream<ValidationResult> resultList = Stream.ofAll(businessEntitiesMetaData)
                .map(me -> metaEntityValidationService.validate(me))
                .filter(x -> !x.isValid());
        if (!resultList.isEmpty()) {
            throw new IllegalStateException(resultList
